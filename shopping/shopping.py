...
def load_data(filename):
    ...
    shopping_df = encode_categorical_variables(pd.read_csv(file_path))

    evidence_columns = ['Administrative', 'Administrative_Duration', 'Informational',
    ...
    evidence = shopping_df[evidence_columns].values.tolist()
    labels = shopping_df[label_column].squeeze().tolist()
